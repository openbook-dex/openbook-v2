...
impl BookSide {
    ...
    pub fn iter_all_including_invalid(&self, now_ts: u64, oracle_price_lots: Option<i64>) -> BookSideIter {
    ...
    pub fn remove_worst(&mut self, now_ts: u64, oracle_price_lots: Option<i64>) -> Option<(LeafNode, i64)> {
